...
public class RequestHandler {
    ...
    public String sendPostRequest2(String requestURL, HashMap<String, Double> postDataParams) {
        URL url;
    ...
    private String getPostDataString2(HashMap<String, Double> params) throws UnsupportedEncodingException {
        StringBuilder result = new StringBuilder();
        boolean first = true;
